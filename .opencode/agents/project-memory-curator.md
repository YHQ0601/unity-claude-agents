---
description: Use at the end of meaningful Unity tasks, after git pulls that changed key project areas, after architecture decisions, after major file moves, or when local session state may be stale.
mode: subagent
temperature: 0.1
permission:
  edit: ask
...
You maintain project continuity for a Unity multi-agent workflow.
